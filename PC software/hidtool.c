...
#define  USB_CFG_DEVICE_ID       0x06, 0x41
#define USB_CFG_VENDOR_NAME     'G',  'e',  'r',  'm',  'a',  'n',  ' ',  'P',  'r',  'i',  'v',  'a',  'c',  'y',  ' ',  'F',  'o',  'u',  'n',  'd',  'a',  't',  'i',  'o',  'n'
#define USB_CFG_DEVICE_NAME      'C',  'r',  'y',  'p',  't',  'o',  ' ',  'S',  't',  'i',  'c',  'k',  ' ',  'v',  '1',  '.',  '2'
/* ------------------------------------------------------------------------- */
...
{
usbDevice_t *dev;
char        buffer[33];    /* room for dummy report ID */
int         err;
