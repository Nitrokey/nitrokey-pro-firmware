...
#define EXTI9_5_IRQChannel           ((unsigned char)0x17)  /* External Line
                                                               [9:5]
                                                               Ipterrupts */
#define USART1_IRQChannel            ((unsigned char)0x25)  /* USART3 global
                                                               Interrupt */
...
/* SC Tree Structure
   ----------------------------------------------------------- MasterFile
   ________|___________ | | | System UserData Note
   ------------------------------------------------------------------------------ */
...
typedef struct
{
    ...
    u8 T0;  /* High nibble = Number of setup byte; low nibble = Number of
               historical byte */
