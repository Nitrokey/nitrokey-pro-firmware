...
#define GPIO_Remap_USART1          ((uint32_t)0x00000004)   /* USART1 tlternate Function mapping */
#define GPIO_Remap_USART2          ((uint32_t)0x00000008)   /* USART2 tlternate Function mapping */
