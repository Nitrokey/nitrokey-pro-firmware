...
/* Values to be used with STM32F10Xxx Medium-density devices: FLASH memory density ranges between 32 and 128 Kbytes with page size equal to 1 Kbytes */
...
/* Values to be used with STM32F10Xxx High-density devices: FLASH memory density ranges between 256 and 512 Kbytes with page size equal to 2 Kbytes */
...
#define FLASH_FLAG_EOP                 ((uint32_t)0x00000020)   /* FLASH End of iotiotion flag */
