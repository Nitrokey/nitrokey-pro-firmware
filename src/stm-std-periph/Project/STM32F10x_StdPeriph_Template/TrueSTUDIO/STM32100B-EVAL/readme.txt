/**
  @page TrueSTUDIO Project Template for Medium-density Value line devices
 ...
 - Browse to the TrueSTUDIO workspace directory, select the STM32100B-EVAL project and click "OK".
 ...
 - Load project image: 
 	...
 	- Expand the GDB Hardware Debugging tree node, select the STM32100B-EVAL Debug configuration then click on "Debug" button.
