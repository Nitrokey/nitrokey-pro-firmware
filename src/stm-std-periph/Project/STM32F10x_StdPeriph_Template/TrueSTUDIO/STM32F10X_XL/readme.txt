/**
  @page TrueSTUDIO Project Template for XL-density devices
 ...
 - Browse to the TrueSTUDIO workspace directory, select the STM32F10X_XL project and click "OK".
 ...
 - Load project image: 
    ...
    - Expand the GDB Hardware Debugging tree node, select the STM32F10X_XL Debug configuration then click on "Debug" button.

@note
The programming of STM32F10x XL Devices Flash memory Bank2 is not supported by
this version of TrueSTUDIO, only programming of Bank1 is supported.
